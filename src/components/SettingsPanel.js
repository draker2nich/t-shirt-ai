    ...
    <div className="bg-white rounded-lg border border-gray-200 p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select 
            ...
            disabled={disabled}
            className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:bg-gray-50 disabled:text-gray-500 transition-colors"
          >
      ...
      <div className="mt-4 px-3 py-2 bg-indigo-50 border border-indigo-100 rounded-lg">
        <p className="text-xs text-indigo-800">
          <span className="font-semibold">Tip:</span> Use "Seamless Repeating" for best results on textiles
        </p>
      </div>
    </div>
  );
